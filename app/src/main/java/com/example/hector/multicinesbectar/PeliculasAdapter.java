...
public class PeliculasAdapter extends BaseAdapter {
    ...
    public PeliculasAdapter(Activity context, ArrayList<HashMap<String, String>> peliculas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.peliculas_layout, parent, false);
